...
namespace WebDevelop.Areas.Admin.Controllers
{
	public class TopicController : Controller
	{
		...
		public ActionResult Status(int? id)
		{
			...
			if (topics == null)
			{
				//Thong bao that baiTempData["message"] = new XMessage("danger", "Cập nhật trạng thái thất bại");
		...
		public ActionResult DeleteConfirmed(int id)
		{
			...
			//tim thay mau tin thi xoa, cap nhat cho Linksif (topicsDAO.Delete(topics) == 1)
			{
				Links links = linksDAO.getRow(topics.Id, "topic");
				//Xoa luon cho Links
